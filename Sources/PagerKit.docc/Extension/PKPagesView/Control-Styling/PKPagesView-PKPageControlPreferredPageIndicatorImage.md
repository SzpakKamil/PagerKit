...
@TabNavigator {
    @Tab("iOS") {
        ...
        @Row(numberOfColumns: 2) {
            @Column {
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-iOS-Default", alt: "Default") {
                    Default
                }
            }
            @Column {
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-iOS-Custom", alt: "Custom") {
                    Custom
                }
            }
        }
    ...
    @Tab("iPadOS") {
        ...
        @Row(numberOfColumns: 2) {
            @Column(size: 2) {
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-iPadOS-Default", alt: "Default") {
                    Default
                }
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-iPadOS-Custom", alt: "Custom") {
                    Custom
                }
            }
        }
    ...
    @Tab("macOS") {
        ...
        @Row(numberOfColumns: 2) {
            @Column(size: 2) {
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-macOS-Default", alt: "Default") {
                    Default
                }
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-macOS-Custom", alt: "Custom") {
                    Custom
                }
            }
        }
    ...
    @Tab("visionOS") {
        ...
        @Row(numberOfColumns: 2) {
            @Column(size: 2){
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-visionOS-Default", alt: "Default") {
                    Default
                }
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-visionOS-Custom", alt: "Custom") {
                    Custom
                }
            }
        }
    ...
    @Tab("watchOS") {
        ...
        @Row(numberOfColumns: 2) {
            @Column {
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-watchOS-Default", alt: "Default") {
                    Default
                }
            }
            @Column {
                @Image(source: "Documentation-PKPages-PKPageControlIndicatorPreferredIndicatorImage-watchOS-Custom", alt: "Custom") {
                    Custom
                }
            }
        }
